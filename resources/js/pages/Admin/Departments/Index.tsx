...
export default function DepartmentsIndex({ departments }: Props) {
    ...
    return (
        <>
            ...
            <PageHeader
                title="Departments"
                subtitle="Manage department routing, managers, and default SLA assignments."
                headerActions={
...
type DepartmentsIndexComponent = typeof DepartmentsIndex & {
    layout?: (page: ReactElement) => React.ReactNode;
};

(DepartmentsIndex as DepartmentsIndexComponent).layout = appShellLayout;
