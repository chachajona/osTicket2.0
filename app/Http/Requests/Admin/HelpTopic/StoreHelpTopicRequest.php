...
class StoreHelpTopicRequest extends AdminFormRequest
{
    public function authorize(): bool
    {
        return parent::authorize() && $this->user('staff')?->can('create', HelpTopic::class);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'topic_pid' => ['nullable', 'integer', Rule::exists($helpTopicsTable, 'topic_id')],
