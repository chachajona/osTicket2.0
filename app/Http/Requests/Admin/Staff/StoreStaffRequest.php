...
class StoreStaffRequest extends AdminFormRequest
{
    public function authorize(): bool
    {
        return parent::authorize() && $this->user('staff')?->can('create', Staff::class);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            'username' => ['required', 'string', 'max:32', Rule::unique($staffTable, 'username')],
